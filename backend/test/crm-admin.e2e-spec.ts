...
describe('crm — Administração do CRM (e2e)', () => {
  ...
  describe('guard + catálogo', () => {
    ...
    it('catálogo expõe o recurso crm_admin (4 da 007 + gerir_campos_lead da 008 + gerir_tags da 009 + gerir_pipelines da 010 + gerir_whatsapp da 011 + gerir_atendimento da 012 + gerir_faq da 013 + gerir_workflow da 014)', async () => {
      ...
      expect(grupo.permissoes).toHaveLength(11);
